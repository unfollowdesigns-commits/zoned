      ...
      <section className="v-light">
        ...
        <Reveal>
          <h2
            ...
            style={{ fontSize: "clamp(32px, 4vw, 56px)", lineHeight: 1.02, letterSpacing: "-0.032em" }}
          >
        ...
        <Reveal delay={0.08}>
          <p className="mt-7 max-w-[46ch] text-[19px] font-semibold leading-[1.5] text-[var(--v-primary-deep)]">
