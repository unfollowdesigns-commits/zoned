  ...
  return (
    <Reveal>
      <div className="v-well rounded-[var(--radius)] p-8 sm:p-10">
        ...
        <h2 className="v-display text-[length:var(--t-body)] leading-[1.3]">
        ...
        <div className="mt-7 flex flex-wrap gap-3">
          <Link
            href="/contact"
            className="rounded-full bg-[var(--v-primary)] px-5 py-2.5 text-[length:var(--t-secondary)] font-semibold text-white transition-colors duration-200 hover:bg-[var(--v-primary-deep)]"
          >
            Get Started
          </Link>
          <Link
            href="/"
            className="rounded-full border border-[var(--v-border)] px-5 py-2.5 text-[length:var(--t-secondary)] font-medium transition-colors duration-200 hover:border-[var(--v-border-strong)]"
          >
            Back to home
          </Link>
        </div>
